<template>
  <nav class="navbar" :class="{ 'navbar-scrolled': isScrolled }" v-if="!searchResultsVisible">
    ...
    <div class="sidebar" v-else>
      ...
      <ul class="kategori">
        <li>
          <router-link to="/pakaian-wanita">PAKAIAN</router-link>
        </li>
        <li>
          <router-link to="/aksesoris-wanita">AKSESORIS</router-link>
        </li>
        <li>
          <router-link to="/tas-wanita">TAS | RANSEL</router-link>
        </li>
        <li>
          <router-link to="/pasific-republic-wanita">PASIFIC REPUBLIC</router-link>
        </li>
      </ul>
    </div>
    <div class="sidebar-content" :class="{ 'show-sidebar': isSidebarVisible || isHovered }">
      <ul class="main-links">
        <li>
          <router-link to="/woman">WANITA</router-link>
        </li>
        <li>
          <p>|</p>
        </li>
        <li>
          <router-link to="/man">PRIA</router-link>
        </li>
      </ul>
      <ul class="kategori">
        <li>
        ...
        <li>
          <router-link to="/man">PASIFIC REPUBLIC</router-link>
        </li>
      </ul>
      <ul class="kategori2">
        <li>
